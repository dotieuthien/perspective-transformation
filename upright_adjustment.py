...
def gradient_descent_optimizer(image, max_iters, learning_rate):
    ...
    for i in range(max_iters):
        ...
        init_theta = np.float32(init_theta - theta * 0.01)
        init_phi = np.float32(init_phi - phi * 0.01)
        init_gamma = np.float32(init_gamma - gamma * 0.01)
        ...
        cv2.imwrite('image_out_.png', image_out)
